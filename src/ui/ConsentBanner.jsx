...
import { configureAnalytics, resolveGaId } from "../utils/analytics";
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-[1000] px-4 pb-4">
      <div
        ...
        className="mx-auto max-w-3xl rounded-card bg-surface p-5 shadow-spa-hover sm:p-6"
      >
        <h3 id="consent-title" className="mb-2 text-sm font-bold text-milk">
          {t("consent.title")}
        </h3>
        ...
        <div className="mt-5 flex flex-col gap-3 sm:flex-row sm:items-center">
          ...
          <a
            ...
            className="text-sm text-stone underline underline-offset-4 transition hover:text-gold sm:ml-auto"
            rel="noopener"
          >
            {t("consent.privacy")}
          </a>
