  ...
  return (
    <>
      <AdminPageHeader
        ...
        description={
          isSupabaseEnabled
            ? "Редактируйте секции сайта NUAR. Изменения сохраняются в CRM backend и видны всем посетителям."
            : "Редактируйте все секции сайта NUAR. Изменения сохраняются локально — подключите CRM backend для синхронизации с продакшеном."
        }
      />
