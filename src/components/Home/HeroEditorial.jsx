    ...
    <div className="relative h-full w-full overflow-hidden">
      ...
      <div className="relative z-10 flex h-full flex-col justify-end px-5 pb-16 pt-28 sm:px-8 sm:pb-20 lg:px-12 lg:pb-24">
        <div className="max-w-2xl">
          ...
          <h1 className="mt-4 font-display text-display-md text-milk text-balance sm:text-display-lg lg:max-w-xl">{t("hero.title")}</h1>
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center">
            ...
            <Link to="signature" smooth duration={600} offset={-80} className="inline-flex min-h-[52px] items-center justify-center px-2 text-sm text-stone transition hover:text-milk">
              {t("hero.ctaSecondary")}
            </Link>
          </div>
        </div>
